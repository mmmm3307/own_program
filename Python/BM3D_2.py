...
Step1_blk_threshold = lamda_2d * sigma
    ...
    *_BlockPoint:当前block的坐标及大小
    ...
    for i in range(blk_num):
        for j in range(blk_num):
            ...
            dct_Tem_img[numpy.abs(dct_Tem_img[:]) < Step1_blk_threshold] = 0.
...
if __name__ == '__main__':
    ...
    # 记录程序运行时间
    """
    img = cv2.imread('/home/ciiv04/program/own_program/Python/test/gray/gray3.jpg',cv2.IMREAD_GRAYSCALE)
    # e1 = cv2.getTickCount()  # cv2.getTickCount 函数返回从参考点到这个函数被执行的时钟数
    # if(img is not None):
    #     print("success")
    # cv2.imwrite('./img/gray2.jpg',img)
    ...
    cv2.imwrite("/home/ciiv04/program/own_program/Python/test/BM3D/basic/basic3.jpg", Basic_img)
    ...
    cv2.imwrite("/home/ciiv04/program/own_program/Python/test/BM3D/final/final3.jpg", Final_img)
