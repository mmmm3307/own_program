...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/ciiv04/program/own_program/Python/test/t33.png',cv2.IMREAD_GRAYSCALE)
    Basic_img = BM3D_1st_step(img)
    cv2.imwrite("/home/ciiv04/program/own_program/Python/test/BM3D/basic/t33_basic.jpg", Basic_img)

    # Basic_img = cv2.imread("./img/denoised.png", cv2.IMREAD_GRAYSCALE)

    Final_img = BM3D_2nd_step(Basic_img, img)
    cv2.imwrite("/home/ciiv04/program/own_program/Python/test/BM3D/final/t33_final.jpg", Final_img)
